...
public class ProductImpl extends CategoryImpl implements Product {
	...
	public boolean editProduct(ProductObject item) {
		...
		sql += "product_name = ?,product_status = ?,";
		...
		try {
			...
			preEdit.setString(1, item.getProduct_name());
			preEdit.setBoolean(2, item.isProduct_status());
			preEdit.setInt(3, item.getProduct_category_id());
			preEdit.setInt(4, item.getProduct_quantity());
			preEdit.setDouble(5, item.getProduct_origin_price());
			preEdit.setDouble(6, item.getProduct_price2());
			preEdit.setDouble(7, item.getProduct_price3());
			preEdit.setInt(8, item.getProduct_price_discount());
			preEdit.setString(9, item.getProduct_specification());
			preEdit.setString(10,item.getProduct_note());
