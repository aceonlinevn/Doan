...
public class GSMConnect implements SerialPortEventListener, CommPortOwnershipListener {
	...
	private static String comPort = "COM4"; // This COM Port must be connect
	...
	public void sendMessage(String phoneNumber, String message) {
		...
		send("AT+CMGS=\""+phoneNumber+enter);
		try {
			Thread.sleep(2000);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("Message Sent false");
		}
	...
	public static void main(String args[]) {
		...
		if (gsm.init()) {
			...
			gsm.sendMessage("+841292723597", "Trial Success");
