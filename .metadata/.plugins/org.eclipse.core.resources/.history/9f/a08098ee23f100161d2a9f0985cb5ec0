...
public class UserLogin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.print("<tr>");
        out.print("<th colspan=2>\u0110\u0103ng nh\u1EADp</th>      <!--Tiêu \u0111\u1EC1 c\u1EE7a b\u1EA3ng là th-table heading-->");
        out.print("</tr>");
        out.print("<tr>");
        ...
        out.print("B\u1EA1n có l\u01B0u thông tin \u0111\u0103ng nh\u1EADp?			<!--khi nh\u1EA5n vào ch\u1EEF s\u1EBD check vào ô-->");
        out.print("</label>");
        out.print("</td>");
        out.print("</tr>");
        out.print("<tr>");
            ...
            if(!username.equalsIgnoreCase("")&&!userpass.equalsIgnoreCase("")){
                if(username.indexOf(" ")!=-1){
                    ...
                    if(user!=null){
                        //Tao phien lam viec
                        //getSession():
                        //ko tham so: Neu co session roi thi dung tiep, neu ko co session thi thoi.
                        //true: da co session: tao moi. chua co: tao moi.
                        //false: da co session: huy session. ko co session: ko lam gi
