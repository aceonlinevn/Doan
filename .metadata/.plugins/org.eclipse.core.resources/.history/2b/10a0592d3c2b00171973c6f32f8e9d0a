...
<%
	...
	Double productDetailPrice = (Double) session.getAttribute("productDetailPrice");
			...
			<div class="l-main-content">
				...
				<div class="single-content">
					...
					<div class="infor-summary">
						<div class="product-price"><% if (productDetailPrice != null) {out.print(Utilities.convertMoney(productDetailPrice));} %></div>
						<div class="clr"></div>
						...
						<div class="products">
							<div class="product">
								...
								<div class="product-image">
									<a href="single.html"
										title="Keyboard Geezer GS4 Mechanical Blue Switch 87"><img
										src="pictures/pr1.jpg"
										alt="Keyboard Geezer GS4 Mechanical Blue Switch 87"></a>
								</div>
								<div class="product-price">699.000</div>
								<div class="product-name">
									<h2>
										<a href="single.html"
											title="Keyboard Geezer GS4 Mechanical Blue Switch 87">Keyboard
											Geezer GS4 Mechanical Blue Switch 87</a>
									</h2>
								</div>
								<div class="product-add-cart">
									<span class="product-stocking"><i
										class="fa fa-shopping-cart" aria-hidden="true"></i> Còn hàng</span> <a
										href="#" title="Mua ngay"><i class="fa fa-cart-plus"
										aria-hidden="true"></i> Mua ngay</a>
								</div>
								<div class="clr"></div>
								<div class="product-hover">
									<div class="product-info">
										<p class="product-name-hover">Keyboard Geezer GS4
											Mechanical Blue Switch 87</p>
										<p class="product-price-hover">
											<span class="price-text">Giá bán: </span><span
												class="img_price">699.000</span>
										</p>
